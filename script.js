...
mostrap(){
   return this.nome + this.datac + this.descricao + this.preco
}
}
...
const Mostrapd = new mostrapd("Rei chikita", "24/5/2021","Pelucia de anime", 2.33,"https://i.pinimg.com/originals/03/9d/7c/039d7ce116e639b24efbc9b66475fd44.jpg")
console.log(Mostrapd.mostrapd())
